...
def Save():
    ...
    if N=='' or C1=='Select Class' or D2=='' or Re1=='' or S1=='' or fathername=='' or mothername=='' or F1=='' or M1=='':
        ...
        try:
            ...
            messagebox.showinfo('info','Profile Picture is available!!!!')
...
def search():
    ...
    try:
        ...
        resized_image=img.resize((190,190))
        phpto2=ImageTk.PhotoImage(resized_image)
        lbl.config(image=photo2)
        lbl.image=photo2
...
Label(root,text='Email: bhavyaviradiya109@gmail.com',width=10,height=3,bg='#f0687c',anchor='e').pack(side=TOP,fill=X)
